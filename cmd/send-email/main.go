...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden;">
  <tr><td style="background:#1a1a2e;padding:24px 32px;">
    <h1 style="margin:0;color:#fff;font-size:22px;">Claude AI News Digest</h1>
  ...
  <tr><td style="padding:16px 32px;background:#f8f8f8;text-align:center;">
    <p style="margin:0;color:#999;font-size:12px;">Generated by Claude AI News Digest</p>
  </td></tr>
</table>
</td></tr>
</table>
...
var plainTmpl = template.Must(template.New("plain").Parse(`Claude AI News Digest — {{.SearchDate}}
========================================
{{range .Items}}
[{{.Category}}] {{.Title}}
{{.Summary}}
...
{{end}}
---
Generated by Claude AI News Digest
`))
...
func main() {
	...
	m.Subject(fmt.Sprintf("Claude AI News Digest — %s", digest.SearchDate))
